...
class ForumEmailPreference(models.Model):
    """
    User preferences for forum email notifications
    """
    ...
    notify_new_posts = models.BooleanField(default=True, help_text="Receive emails for new forum posts")
    notify_new_comments = models.BooleanField(default=True, help_text="Receive emails for new comments on posts")
    notify_replies_to_my_posts = models.BooleanField(default=True, help_text="Receive emails when someone comments on your posts")
    notify_replies_to_my_comments = models.BooleanField(default=True, help_text="Receive emails when someone replies to your comments")
    notify_mentions = models.BooleanField(default=True, help_text="Receive emails when someone mentions you")
    notify_likes = models.BooleanField(default=False, help_text="Receive emails when someone likes your post/comment")
    
    # Digest options
    enable_daily_digest = models.BooleanField(default=False, help_text="Receive daily digest of forum activity")
    enable_weekly_digest = models.BooleanField(default=False, help_text="Receive weekly digest of forum activity")
