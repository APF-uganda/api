...
STRAPI_BASE_URL = env("STRAPI_BASE_URL", default="http://64.225.121.230:1337")
STRAPI_TOKEN = env("STRAPI_TOKEN", default="")
...
# Trust the X-Forwarded-Host and X-Forwarded-Proto headers from nginx
